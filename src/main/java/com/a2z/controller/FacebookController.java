...
import com.a2z.utils.FacebookUtil;
import com.a2z.utils.OAuthServiceProvider;
...
public class FacebookController<FacebookApi> {
	...
	private static final String PUBLISH_SUCCESS = "sucess";
	...
	public String postOnWall(@RequestParam("code") String code,
		...
		MultiValueMap<String, Object> map = facebookUtil.publishLinkWithVisiblityRestriction(state);
